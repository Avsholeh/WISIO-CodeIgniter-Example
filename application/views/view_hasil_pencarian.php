...
<body>
    ...
    <section class="container-fluid" id="main">
        ...
        <article class="col-md-8">
            <span class="text-center">Hasil pencarian : <?php if(isset($jumlah_artikel)){echo $jumlah_artikel;} ?></span>
                ...
                <div class="panel-body">
                    <div>   
                        ...
                        <?php 
                            ...
                            echo "...<br><br>";
                            echo "<small><a href=". base_url('home/artikel') ."/". $row_artikel->id_artikel.">Baca Selengkapnya...</a></small>";
                        ?>
