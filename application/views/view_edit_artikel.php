        ...
        <article class="col-md-8 col-md-push-2"> 
            <div class="panel panel-default">
                <div class="panel-body">
                    <form method="post" action="<?php echo base_url('user/revisi_artikel')."/".$this->uri->segment(3, 0) ?>">
                        <label>Revisi Artikel</label><br>
                        <small>*Catatan: Status artikel setelah diedit atau direvisi akan berubah menjadi "belum diseleksi".</small>
