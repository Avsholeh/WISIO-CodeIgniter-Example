        ...
        <article class="col-md-8">
            ...
            <div class="panel panel-default">    
                <div class="panel-heading">                    
                    <a href=" <?php echo base_url('home/artikel'). "/" . $row_artikel->id_artikel ?>"><h1><?php echo $row_artikel->judul ?></h1></a>
                </div>
                <div class="panel-body">
                    <div>
                        ...
                        <?php 
                            ...
                            echo "...<br><br>";
                            echo "<small><a href=". 
                                base_url('home/artikel') ."/". $row_artikel->id_artikel.">Baca Selengkapnya...</a></small>";
                        ?>
